...
class Potenciometro(Node):
    def __init__(self):
        ...
        self.sub_raw_position = self.create_subscription(Float32, 'potenciometro/posicion_acondicionada', self.raw_position, 10)
    ...
    def log_data(self):
        ...
        self.get_logger().info(f'Señal Acond.:{self.current_conditioned_signal} Pos. Acond: {self.current_conditioned_position:.2f}')
